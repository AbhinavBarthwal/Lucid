...
//        
//        // Convert Float arrays into time-series data
...
//                
//                // Changed to estimated height so the section expands to fit 2 charts vertically
//                let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .estimated(600))
//                let group = NSCollectionLayoutGroup.vertical(layoutSize: groupSize, subitems: [item])
//                let section = NSCollectionLayoutSection(group: group)
//                section.contentInsets = NSDirectionalEdgeInsets(top: 12, leading: 8, bottom: -8, trailing: 8)
...
//            
//            if indexPath.item == 0 {
//                cell.configure(title: "Left Eye Intensity", data: self.leftChartData, description: "Red bars indicate incomplete blinks by your left eye which can cause eye strain. Aim to hit every bar beyond the target line.")
//            } else {
//                cell.configure(title: "Right Eye Intensity", data: self.rightChartData, description: "Red bars indicate incomplete blinks by your right eye which can cause eye strain. Aim to hit every bar beyond the target line.")
//            }
//            return cell
//        }
//    }
...
class ReportViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var overallScore: Int = 0
    var totalErrors: Int = 0
    var chartData: [String: [Float]] = [:] // Used for Blink peaks
