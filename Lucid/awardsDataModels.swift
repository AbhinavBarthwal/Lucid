...
class ProgressManager {
    ...
    func loadBadges() -> [Badge] {
        ...
        return [
            Badge(id: "exercise_1", title: "1st Exercise", imageName: "trophy.circle", dateEarned: nil, isUnlocked: false),
            Badge(id: "streak_1", title: "1 Day Streak", imageName: "trophy.circle", dateEarned: nil, isUnlocked: false),
            Badge(id: "test_10", title: "10th Test", imageName: "trophy.circle", dateEarned: nil, isUnlocked: false)
        ]
    }
}
