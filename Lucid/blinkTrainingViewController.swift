...
enum TrainingPhase {
    ...
    case singleBlink(eye: String, remaining: Int) // "left" or "right"
    case completed
}
...
class blinkTrainingViewController: UIViewController, ARSCNViewDelegate {
    ...
    @IBOutlet var instructionLabel: UILabel! // Added for user guidance
    @IBOutlet var sceneView: ARSCNView!
        ...
        // MARK: - Error & Skip Logic
        private var totalErrors = 0
        private var failedAttemptsForCurrentBlink = 0 // Tracks the 10-fail rule
        private var consecutiveErrors = 0 // Tracks for immediate nudge
        ...
        func renderer(_ renderer: SCNSceneRenderer, didUpdate node: SCNNode, for anchor: ARAnchor) {
            ...
            // Track peaks for the summary graph
        ...
        private func handleError() {
            ...
            DispatchQueue.main.async {
                ...
                // Show nudge after 3 fast errors
                if self.consecutiveErrors >= 3 { self.showContextualNudge() }
                
                // Skip logic: 10 failures moves to next blink
