...
//
//        
//        //variables to track number of each blink
//        private var leftBlinksPerformed = 0
//        private var rightBlinksPerformed = 0
//        private var doubleBlinksPerformed = 0
//
//
//            
//            // Timer label added to match near/far logic
...
//                    switch self.currentPhase {
//                    case .doubleBlink:
//                        self.doubleBlinksPerformed += 1
//                    case .singleBlink(let eye, _):
//                        if eye == "left" { self.leftBlinksPerformed += 1 }
//                        else { self.rightBlinksPerformed += 1 }
//                    default: break
//                    }
//                    
//                    self.currentPhase.decrement()
...
//        
//        func finishExercise() {
//            // 1. Calculate and prepare all data OUTSIDE the async block
//            let score = max(0, 100 - (self.totalErrors * 5))
//            let errors = self.totalErrors
//            
//            // (If Xcode throws an error right here, it means you forgot to add
//            // leftBlinksPerformed, rightBlinksPerformed, or doubleBlinksPerformed
//            // to the top of your class!)
//            let dynamicChartData: [BlinkBarData] = [
//                BlinkBarData(category: "Left", performed: self.leftBlinksPerformed, total: LeftRighEyeBlink),
//                BlinkBarData(category: "Right", performed: self.rightBlinksPerformed, total: LeftRighEyeBlink),
//                BlinkBarData(category: "Both", performed: self.doubleBlinksPerformed, total: doubleBlink)
//            ]
//            
//            DispatchQueue.main.async {
...
//                
//                reportVC.overallScore = score
//                reportVC.totalErrors = errors
//                reportVC.chartData = dynamicChartData
//                
