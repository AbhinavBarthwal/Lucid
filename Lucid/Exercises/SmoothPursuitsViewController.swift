...
class SmoothPursuitsViewController: UIViewController, ARSessionDelegate {
    ...
    private var sessionStartTime: Date? //starts times for exercise execution
    private enum ExercisePhase { case none, tracking }
    private var currentPhase: ExercisePhase = .none
    private var gazeTimer: Timer? //Timer to periodically check gaze
    ...
    // recursively shows instructions one after the another
